angular.module('omnicontrol').factory('TipoOperacao', function($resource){
    return $resource("/omnicontrol/api/tipooperacao/:id"); // todo servico criado com uma factory deve retornar um objeto
});
