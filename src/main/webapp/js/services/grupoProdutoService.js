angular.module('omnicontrol').factory('GrupoProduto', function($resource){
    return $resource("/omnicontrol/api/grupoproduto/:id"); // todo servico criado com uma factory deve retornar um objeto
});
